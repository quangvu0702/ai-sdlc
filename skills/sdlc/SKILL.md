...
name: sdlc
description: >-
  Run the AI SDLC flow from flows/*.json one step at a time with a human
  approval gate between steps. Use when the user runs /sdlc, starts or resumes
  a lifecycle run, or passes a Jira key plus flow name.
